...
from prometheus.message import TokenizeMsg
from prometheus.tokenizer.effort import EFFORT_SCALE, KNOWN_REASONING_EFFORTS
...
async def _effort_fields(state: Any) -> tuple[list[str] | None, str | None]:
    ...
    try:
        ...
        return None, None
    from prometheus.tokenizer.effort import effective_efforts
