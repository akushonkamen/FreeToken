...
protocol-neutral primitive (:func:`prometheus.server.openai_api.submit_generation` +
...
class ResponsesRequest(BaseModel):
    """The subset of the Responses request Prometheus honors (extra fields allowed)."""
