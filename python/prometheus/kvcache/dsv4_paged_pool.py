"""DSV4 paged KV pools (sglang-style management, Prometheus byte layout).
...
class DSV4PagedKVCache(BaseKVCachePool):
    ...
    def solve_num_pages(cls, config, available_memory: int) -> int:
        ...
        from prometheus.utils import mem_GB
    ...
    def validate_rebuild(
        ...
        from prometheus.engine.cache_budget import net_cache_budget_bytes
        from prometheus.utils import mem_GB
