...
from prometheus.utils import align_ceil, div_even
...
class HybridSWAKVCache(BaseKVCachePool):
    ...
    def store_kv(
        ...
        from prometheus.kernel import store_cache
...
def _swa_per_req_swa_floor(config) -> int:
    ...
    from prometheus.scheduler.cache import _SWA_EVICTION_INTERVAL, _SWA_RETAIN_GAP
