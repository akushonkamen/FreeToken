"""CLI: convert an HF safetensors checkpoint to a Prometheus Weight (FTW) checkpoint.

    prom checkpoint --model <hf_dir> --out <ftw_dir> \
...
from prometheus.gpu_select import assign_gpu, bind_assigned_gpu, single_gpu_arg
...
def main(argv: list[str] | None = None, prog: str = "prometheus.checkpoint") -> int:
