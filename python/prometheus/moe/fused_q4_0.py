...
Ports vLLM/sglang's ``_fused_moe_gguf`` MMVQ path onto Prometheus's offload-cache
...
from prometheus.layers.activation import gelu_and_mul, gelu_tanh_and_mul, silu_and_mul
from prometheus.models.gguf.dequant import GGML_Q4_0
...
def fused_experts_gguf_q4_0(
    ...
    from prometheus.kernel.gguf import ggml_moe_a8_vec
