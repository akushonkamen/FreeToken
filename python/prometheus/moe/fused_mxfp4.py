...
from prometheus.moe.fused import moe_align_block_size, try_get_optimal_moe_config
...
def run_mxfp4_splitk_decode_experts(
    ...
    *,
    ...
    from prometheus.kernel import gpt_oss_swiglu_triton, mxfp4_splitk_gemv_triton
