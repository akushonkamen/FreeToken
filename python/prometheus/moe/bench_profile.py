...
def load_backend_recommendation(
    ...
    # Preferred: the per-dtype tuning verdicts (`prom bench bw --dtype`), a direct format->backend
    ...
    # Fallback: a per-model profile (`prom bench bw --model`). Aggregate the workloads sharing this
