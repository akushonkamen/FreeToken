...
Mirrors :mod:`prometheus.moe.fused` (gemm1 -> act -> gemm2 -> sum-reduce) but the two
...
from prometheus.kernel.triton.e4m3_compat import e4m3_kernel_view
from prometheus.kernel.triton.nvfp4_fused_moe import (
