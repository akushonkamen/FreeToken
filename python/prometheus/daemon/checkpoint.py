"""Supervise ``prom checkpoint`` conversions the same way the serve is supervised. GPU exclusivity
...
it only spawns ``prom checkpoint`` as a child."""
...
class CheckpointManager:
    ...
    def _default_spawn(self, job_id: str, args: list[str]):
        ...
        argv = [self._python, "-m", "prometheus.cli", "checkpoint", *args]
