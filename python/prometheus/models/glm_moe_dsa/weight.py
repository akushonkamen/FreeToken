...
/ ``dense_quant`` / ``lm_head_quant``, from the PROMETHEUS_GLM_*_FP8 switches, default
...
from prometheus.models.glm4_moe.weight import (
    ...
    *,
    ...
    if primary:
        ...
        init_logger(__name__).info(
            ...
            f"lm_head={config.lm_head_quant} (PROMETHEUS_GLM_ATTN_FP8/PROMETHEUS_GLM_MLP_FP8; "
