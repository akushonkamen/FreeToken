...
# forward runs Prometheus's own shared
# W4A16 kernel (prometheus.kernel.triton.nvfp4_linear) -- reading the FP4 weight directly (fp32
...
class LinearNVFP4(BaseOP):
    ...
    when vLLM is absent) it runs the shared Prometheus W4A16 kernel directly on the packed FP4
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        # Shared Prometheus W4A16 kernel: read the packed FP4 weight directly (no bf16 scratch).
