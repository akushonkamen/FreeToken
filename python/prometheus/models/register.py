...
_MODEL_REGISTRY: dict[str, ModelSpec] = {
    "LlamaForCausalLM": ModelSpec(
        "prometheus.models.llama",
        "LlamaForCausalLM",
    ),
    "Qwen2ForCausalLM": ModelSpec(
        "prometheus.models.qwen2",
        "Qwen2ForCausalLM",
    ),
    "Qwen3ForCausalLM": ModelSpec(
        "prometheus.models.qwen3",
        "Qwen3ForCausalLM",
    ),
    "Qwen3MoeForCausalLM": ModelSpec(
        "prometheus.models.qwen3_moe",
        "Qwen3MoeForCausalLM",
    ),
    "MiniMaxM2ForCausalLM": ModelSpec(
        "prometheus.models.minimax_m2",
    ...
    "MuseGlimmerForConditionalGeneration": ModelSpec(
        "prometheus.models.muse_glimmer",
        "MuseGlimmerForCausalLM",
    ),
    "MistralForCausalLM": ModelSpec(
        "prometheus.models.mistral",
        "MistralForCausalLM",
    ),
    ...
    "GptOssForCausalLM": ModelSpec(
        "prometheus.models.gpt_oss",
        "GptOssForCausalLM",
    ),
    "Glm4MoeForCausalLM": ModelSpec(
        "prometheus.models.glm4_moe",
        "Glm4MoeForCausalLM",
    ),
