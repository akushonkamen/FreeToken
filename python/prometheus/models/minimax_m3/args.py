...
MiniMax-M3 is a 428B-A23B multimodal MoE (Prometheus serves the text tower; the
...
def load_args(text_config: Any, num_layers: int, *, sparse_enabled: bool) -> MiniMaxM3Args:
    ...
    the sparse-attention switch ONCE here (``sparse_enabled`` folds PROMETHEUS_M3_SPARSE
