...
/ ``dense_quant``, from the PROMETHEUS_M3_*_MXFP8 switches, default on): in the default
...
from prometheus.models.loader import drop_page_cache
...
def _emit_fused(
    ...
    if keep_mxfp8 and all(s is not None for _, s in parts):
        ...
        return
    from prometheus.kernel.triton.mxfp8_linear import mxfp8_dequant
    ...
    *,
    ...
    if primary:
        ...
        init_logger(__name__).info(
            ...
            f"lm_head={config.lm_head_quant} (PROMETHEUS_M3_ATTN_MXFP8/PROMETHEUS_M3_MLP_MXFP8; "
