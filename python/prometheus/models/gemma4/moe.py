...
import torch
from prometheus.kernel.triton.gemma4_fused import gemma_dual_rmsnorm_residual_scalar
from prometheus.layers import BaseOP, GemmaRMSNorm, LinearReplicated, make_moe_layer
from prometheus.models.blocks import GatedMLP
...
class Gemma4Router(BaseOP):
    ...
    def __init__(self, config: ModelConfig):
        ...
        from prometheus.kernel.triton.gemma4_fused import gemma4_fused_routing
...
class _Nvfp4GatedMLP(BaseOP):
    ...
    def __init__(self, config: ModelConfig):
        ...
        from prometheus.layers import gelu_tanh_and_mul
