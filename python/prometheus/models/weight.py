...
from prometheus.kernel.pinned import alloc_pinned_tensor, copy_to_pinned_tensor
from prometheus.models.loader import stream_moe_expert_sources
from prometheus.utils import cached_load_hf_config, div_even
...
def load_weight(
    ...
    *,
    ...
    from prometheus.checkpoint.ftw import is_ftw_checkpoint, iter_ftw_weights
    from prometheus.models.config import VISION_KEY_PREFIXES, vision_load_enabled
