...
from prometheus.layers import BaseOP, GemmaRMSNorm
from prometheus.layers.rotary import get_rope
from prometheus.models.config import SWAAttentionGroupConfig
from prometheus.utils import nvtx_annotate

from prometheus.models.quant_linear import make_col_merged, make_replicated
