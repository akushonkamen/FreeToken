...
Optional pure-triton drop-in for prometheus.kernel.sampling / flashinfer.sampling
...
from prometheus.kernel.triton.autotune_cache import autotune_cache_kwargs
