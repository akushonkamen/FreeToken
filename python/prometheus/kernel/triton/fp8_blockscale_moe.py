...
def fused_experts_decode_fp8_blockscale(
    ...
    from prometheus.kernel import moe_sum_reduce_triton
    from prometheus.layers import silu_and_mul
...
def fused_experts_fp8_blockscale(
    ...
    from prometheus.kernel import moe_sum_reduce_triton
    from prometheus.layers import silu_and_mul
    from prometheus.kernel.triton.fp8_block_linear import per_token_group_quant_fp8
    from prometheus.moe.fused import moe_align_block_size
