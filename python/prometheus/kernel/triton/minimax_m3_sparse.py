...
tree -- the semantics source of truth), adapted to Prometheus's storage model:

* Prometheus's page table is page_size=1 semantics (one physical TOKEN row per
...
* KV is always bf16 (Prometheus pools); the fp8-KV dequant branches are dropped.
