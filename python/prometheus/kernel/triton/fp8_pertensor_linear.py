...
NVFP4. Prometheus used to *dequantize these dense weights to bf16 at load* and run them through
...
# Escape hatch: PROMETHEUS_DEBUG_FP8_REF=1 swaps the triton kernels for a pure-torch dequant matmul
# (numeric reference / A-B debugging). Evaluated once; the kernels are the default.
_USE_REF = os.environ.get("PROMETHEUS_DEBUG_FP8_REF") == "1"
