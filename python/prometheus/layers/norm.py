...
class RMSNorm(BaseOP):
    def __init__(self, size: int, eps: float) -> None:
        ...
        if is_flashinfer_installed():
            ...
            from prometheus.kernel.triton.norm import rmsnorm
...
class GemmaRMSNorm(BaseOP):
    ...
    def __init__(self, size: int, eps: float, with_scale: bool = True) -> None:
        ...
        if is_sgl_kernel_installed():
            ...
            from prometheus.kernel.triton.norm import fused_add_rmsnorm, rmsnorm
...
class GemmaPlusOneRMSNorm(BaseOP):
    ...
    def __init__(self, size: int, eps: float) -> None:
        ...
        if is_flashinfer_installed():
            ...
            from prometheus.kernel.triton.norm import gemma_rmsnorm
...
class GemmaPlusOneRMSNormFused(BaseOP):
    ...
    def __init__(self, size: int, eps: float) -> None:
        ...
        if is_flashinfer_installed():
            ...
            from prometheus.kernel.triton.norm import (
