...
def silu_and_mul(x: torch.Tensor, out: torch.Tensor | None = None):
    ...
    if is_flashinfer_installed():
        ...
        from prometheus.kernel.triton.activation import silu_and_mul
...
def gelu_and_mul(x: torch.Tensor, out: torch.Tensor | None = None):
    ...
    if is_flashinfer_installed():
        ...
        from prometheus.kernel.triton.activation import gelu_and_mul
...
def gelu_tanh_and_mul(x: torch.Tensor, out: torch.Tensor | None = None):
    ...
    if is_flashinfer_installed():
        ...
        from prometheus.kernel.triton.activation import gelu_tanh_and_mul
...
def swigluoai_and_mul(
    ...
    *,
    ...
    from prometheus.kernel.triton.activation import swigluoai_and_mul
