"""--gpu for prom serve / bench bw / checkpoint: resolve entries to GPU UUIDs, bind by UUID at CUDA init.
...
Stdlib only (torch is imported lazily); not under prometheus.utils, which imports transformers.
"""
