...
def test_sparse_kernel_equals_dense_when_all_selected():
    ...
    from prometheus.kernel.triton.glm_dsa_sparse import glm_dsa_sparse_attn
...
def test_identity_selection_equals_topk_selection_at_short_kv():
    ...
    from prometheus.attention.dsa_indexer import DSAIndexerMixin
    from prometheus.kernel.triton.glm_dsa_sparse import glm_dsa_sparse_attn
...
def test_decode_logits_edges():
    ...
    from prometheus.kernel.triton.glm_dsa_sparse import glm_dsa_decode_logits
...
def _make_backend(dsa: bool, latent=80, dv=64, idx_dim=32, idx_heads=16, topk=64, pages=400):
    ...
    from prometheus.attention.dsa import DSAAttnBackend
    from prometheus.core import Context, set_global_ctx
