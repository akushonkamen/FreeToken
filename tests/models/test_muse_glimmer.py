...
from prometheus.models.muse_glimmer.config import parse_config
...
def test_registry_resolves_architecture():
    ...
    assert spec.module == "prometheus.models.muse_glimmer"
    assert spec.model_cls == "MuseGlimmerForCausalLM"


def test_aot_table_covers_the_checkpoints():
    from prometheus.kernel.aot_models import SUPPORTED_MODELS
...
def test_weight_rename_and_fusion():
    ...
    from prometheus.models.muse_glimmer.weight import _FUSIONS, _rename
...
def test_iter_weights_bf16_matches_model_state_dict(tmp_path, monkeypatch):
    ...
    from prometheus.models.muse_glimmer.model import MuseGlimmerForCausalLM
    from prometheus.models.muse_glimmer.weight import iter_weights
    ...
    import prometheus.models.muse_glimmer.weight as w
...
def test_raw_config_shim_serves_unknown_model_type(tmp_path):
    ...
    from prometheus.utils.hf import RawConfigShim, _load_hf_config, cached_load_hf_config
...
def test_model_state_dict_matches_loader_keys():
    ...
    from prometheus.kernel.triton.nvfp4_linear import Nvfp4DenseColMerged, Nvfp4DenseLinear
