...
def test_shard_tensor_splits_vocab_with_ceil_partition():
    from prometheus.models.loader import shard_tensor
...
def test_iter_root_safetensor_files_from_index_keeps_only_root_index_shards(tmp_path):
    import json
    from prometheus.models.loader import iter_root_safetensor_files_from_index
...
def test_merge_stream_buffers_qkv_until_all_slots_arrive():
    from prometheus.models.loader import MergeRule, iter_merged_tensors
...
def test_stack_expert_tensors_after_all_experts_arrive():
    from prometheus.models.loader import iter_stacked_experts
