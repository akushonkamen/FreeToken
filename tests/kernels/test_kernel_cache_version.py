"""Version pairing between the runtime and the prometheus-kernel-cache wheel.

The comparator lives in prometheus.kernel.utils; this pins the matrix for the stamped
version scheme (runtime `0.1.1+g<sha>`, cache `0.1.1+cu130.g<sha>`) introduced by
scripts/build-release-wheels.sh."""

import pytest

from prometheus.kernel.utils import _kernel_cache_version_ok
