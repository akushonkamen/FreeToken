...
def test_mxfp8_linear_matches_dequant_reference(M: int, N: int, K: int):
    from prometheus.kernel.triton.mxfp8_linear import mxfp8_dequant, mxfp8_linear
...
def test_gemma_plus_one_norm_matches_flashinfer_semantics():
    ...
    from prometheus.kernel.triton.norm import gemma_fused_add_rmsnorm, gemma_rmsnorm
...
def test_swigluoai_and_mul_uninterleaved():
    from prometheus.layers import swigluoai_and_mul
