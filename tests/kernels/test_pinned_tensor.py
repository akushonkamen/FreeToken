...
def test_pinned_extension_uses_packaged_module_not_runtime_jit(monkeypatch):
    ...
    import prometheus.kernel.pinned as pinned
    ...
    def fake_import_module(name):
        if name == "prometheus.kernel._pinned_tensor":
...
def test_copy_to_pinned_tensor_preserves_strided_cpu_tensor_values():
    ...
    from prometheus.kernel import copy_to_pinned_tensor
...
def test_fast_index_copy_skip_env_noops_without_jit(monkeypatch):
    import prometheus.kernel.fast_index_copy as fast_index_copy
...
def test_device_ptr_pinned_bank_resolves():
    ...
    from prometheus.kernel.pinned import _host_ptr_identity, alloc_pinned_tensor, device_ptr
...
def test_host_device_ptr_is_identity_under_uva():
    ...
    from prometheus.kernel.pinned import _host_ptr_identity, _load_pinned_extension
...
def test_host_bank_pin_registers_and_translates():
    ...
    from prometheus.kernel.pinned import _host_ptr_identity, _load_pinned_extension
    from prometheus.moe.host_banks import HostBank
