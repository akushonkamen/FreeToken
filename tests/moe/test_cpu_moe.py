...
Part 1 -- numerical alignment: the CPU SwiGLU MoE GEMV vs Prometheus's production
...
def test_cpu_decode_matches_gpu_decode_kernel(bs):
    ...
    from prometheus.moe.fused import fused_experts_decode_impl
...
def test_stale_extension_rejected_for_swigluoai(monkeypatch):
    ...
    from prometheus.kernel import _cpu_moe
    from prometheus.moe.cpu_executor import CpuMoeExecutor, compiled_extension_supports
...
def test_cpu_decode_mxfp4_matches_gpu_splitk(bs):
    ...
    from prometheus.moe.cpu_executor import CpuMoeExecutor
    from prometheus.moe.fused_mxfp4 import run_mxfp4_splitk_decode_experts as _run_mxfp4_splitk_decode_experts
