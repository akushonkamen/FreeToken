...
def _marlin_cache(device, *, cache_size=S, prefill_overlap=False):
    from prometheus.moe.nvfp4_backends import marlin_repack_sources_inplace
...
def test_marlin_prefill_matches_dequant_reference():
    from prometheus.moe.nvfp4_backends import marlin_fused_experts
...
def test_dummy_nvfp4_sources_match_loader_contract():
    ...
    from prometheus.models.weight import dummy_nvfp4_expert_sources
...
def test_b12x_pack_is_byte_compatible_with_native_banks():
    ...
    from prometheus.moe.nvfp4_backends import b12x_repack_sources_inplace
