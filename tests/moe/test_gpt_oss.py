...
@pytest.fixture
def tp1(monkeypatch):
    import prometheus.layers.moe as moe_mod
    import prometheus.models.gpt_oss.weight as gpt_weight
...
def test_gpt_oss_fused_routing_matches_softmax_topk_renorm(num_experts):
    from prometheus.kernel import gpt_oss_fused_routing
...
def test_run_mxfp4_splitk_decode_experts_matches_reference(M):
    from prometheus.moe.fused_mxfp4 import run_mxfp4_splitk_decode_experts
...
def test_run_mxfp4_prefill_experts_t_matches_reference(M):
    from prometheus.moe.fused_mxfp4 import run_mxfp4_prefill_experts_t
...
def test_offload_decode_bit_identical_under_eviction(tp1):
    ...
    from prometheus.models.gpt_oss.moe import GptOssMxfp4OffloadMoELayer
    from prometheus.moe.fused_mxfp4 import (
