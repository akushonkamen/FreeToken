...
from prometheus.core import Batch, Context, Req, SamplingParams, get_global_ctx, set_global_ctx
...
def _stack(num_pages=32, max_seq_len=8192):
    ...
    from prometheus.attention.dsv4_sparse import DSV4SparseAttnBackend
