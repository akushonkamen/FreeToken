...
def _pool(num_pages: int):
    from prometheus.kvcache.dsa_pool import DSAKVCache
...
def test_sparse_decode_reads_grown_pool_through_backend_kernels():
    ...
    from prometheus.kernel.triton.glm_dsa_sparse import glm_dsa_decode_logits, glm_dsa_sparse_attn
...
def test_mla_pool_selected_by_group_spec():
    ...
    from prometheus.models.config import FullAttentionGroupConfig, ModelConfig, RotaryConfig
