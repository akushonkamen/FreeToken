...
from prometheus.attention import AttnType
from prometheus.kvcache import resolve_pool_class
from prometheus.models.config import KVCacheGroupSpec
...
def test_resolve_pool_class_follows_attn_type():
    from prometheus.kvcache.dsa_pool import DSAKVCache, MLAKVCache
    from prometheus.kvcache.dsv4_paged_pool import DSV4PagedKVCache
    from prometheus.kvcache.hybrid_swa_pool import HybridSWAKVCache
    from prometheus.kvcache.mha_pool import MHAKVCache
...
def test_generic_kv_cost_and_solve_parity():
    from prometheus.kvcache.base import spec_kv_bytes_per_token
    from prometheus.kvcache.mha_pool import MHAKVCache
...
def _dsv4_config(num_page_override=None):
    from prometheus.models.deepseek_v4.args import DeepseekV4Args
...
def test_dsv4_kv_cost_and_floor_parity():
    from prometheus.kvcache.dsv4_cost_model import _dsv4_swa_ratio, _dsv4_window_floor_pages
    from prometheus.kvcache.dsv4_paged_pool import DSV4PagedKVCache

    pytest.importorskip("prometheus.kvcache.dsv4_cost_model")
    from prometheus.kvcache.dsv4_cost_model import dsv4_auto_cost_model
...
def test_startup_kv_budget_composition():
    ...
    from prometheus.engine.engine import _startup_kv_budget
...
def test_generic_validate_rebuild_budget_check():
    from prometheus.kvcache.base import CacheRebuildRejected
    from prometheus.kvcache.mha_pool import MHAKVCache
...
def test_dsv4_validate_rebuild_floor():
    from prometheus.kvcache.base import CacheRebuildRejected
    from prometheus.kvcache.dsv4_cost_model import _dsv4_window_floor_pages
    from prometheus.kvcache.dsv4_paged_pool import DSV4PagedKVCache
...
def test_rebuild_from_config_explicit_num_swa_pages_wins():
    ...
    from prometheus.distributed import set_tp_info, try_get_tp_info
    from prometheus.kvcache.dsv4_cost_model import _dsv4_pool_sizes
    from prometheus.kvcache.hybrid_swa_pool import _swa_paged_num_tokens, _swa_pool_floor
...
def test_create_kv_pool_builds_the_right_family():
    ...
    from prometheus.distributed import set_tp_info, try_get_tp_info
    from prometheus.kvcache import create_kv_pool
    from prometheus.kvcache.hybrid_swa_pool import _swa_paged_num_tokens
    from prometheus.kvcache.hybrid_swa_pool import HybridSWAKVCache
    from prometheus.kvcache.mha_pool import MHAKVCache
...
def test_linear_state_pool_prices_itself():
    ...
    from prometheus.kvcache.linear_state_pool import (
        _linear_pool_num_slots, linear_state_bytes_per_req, state_pool_bytes,
    )
    from prometheus.models.config import LinearGatedDeltaGroupConfig
...
def test_validate_rebuild_targets_flow_by_kv_cost_signature():
    ...
    from prometheus.distributed import set_tp_info, try_get_tp_info
    from prometheus.kvcache.base import CacheRebuildRejected
    from prometheus.kvcache.hybrid_swa_pool import HybridSWAKVCache, _swa_pool_floor
    from prometheus.kvcache.mha_pool import MHAKVCache
