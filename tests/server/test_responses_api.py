...
from prometheus.server.generation import ContentDelta, GenDone, GenResult, ToolCallsDelta  # noqa: E402
...
def test_stream_reasoning_events():
    from prometheus.server.generation import ReasoningDelta
