...
from prometheus.message import UserReply
from prometheus.server.accounting import (
...
from prometheus.server.stats import StatsTracker
...
def test_idle_prepare_stop_seals_totals_and_is_idempotent(monkeypatch):
    ...
    monkeypatch.setattr("prometheus.server.accounting.time.monotonic", lambda: 100.8)
