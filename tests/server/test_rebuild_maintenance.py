...
from prometheus.server.api_server import FrontendManager, dispatch_rebuild
from prometheus.server.supervisor import (
    BackendHandle,
    LoadProgress,
...
def test_openai_gate_message_is_loading_aware():
    from prometheus.server.openai_api import _maintenance_gate
...
def test_cache_rebuild_guarded_during_loading():
    import prometheus.server.api_server as api
...
def test_cache_rebuild_timeout_keeps_gate_closed():
    ...
    from prometheus.server.api_server import CacheRebuildRequest, cache_rebuild
...
def test_cache_rebuild_request_rejects_unknown_mode():
    ...
    from prometheus.server.api_server import CacheRebuildRequest
