...
from prometheus.server import responses_api as RP  # noqa: E402
from prometheus.server.api_models import ChatCompletionRequest  # noqa: E402
...
from prometheus.server.openai_api import stream_chat_completion_chunks  # noqa: E402
from prometheus.server.responses_api import ResponsesRequest  # noqa: E402
...
def test_non_streaming_detector_falls_back_to_buffered_parse(monkeypatch):
    ...
    from prometheus.server.function_call_parser import Qwen25Detector
...
def test_with_keepalive_emits_sentinel_during_silence():
    from prometheus.server.generation import KEEPALIVE, with_keepalive
