...
def _setup_context() -> None:
    from prometheus.core import Context, get_global_ctx, set_global_ctx
...
def _build_managers(num_pages):
    ...
    from prometheus.scheduler.prefill import PrefillManager
...
def _drive_chunked_prefill(cm, tm, pm, n_chunks):
    ...
    from prometheus.scheduler.prefill import ChunkedReq
